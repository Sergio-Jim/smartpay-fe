  ...
  <div style="padding: 20px 30px">
    <div style="display: flex; flex-direction: row; justify-content: center">
      ...
      >
        <img
          ...
          src="../../../assets/svg/back-button.svg"
          alt=""
      ...
      <div style="display: flex; flex-direction: column; width: 95%">
        ...
        >
          <img
            ...
            alt=""
          />
          <span style="font-size: xx-large">Calendar Report</span>
        </div>
      </div>
    </div>
    <div style="display: flex; flex-direction: row; justify-content: center">
      ...
      <div
        style="display: flex; flex-direction: column; width: 43%; margin: 40px"
      >
        <!-- right side -->
        <div
          class="
    ...
    <div>
      ...
      <span style="display: flex; justify-content: center"
        >Click on '9th June 2022' '13 May 2022' '11 May 2022' '20 May
        2022'</span
      >
    </div>
  </div>
